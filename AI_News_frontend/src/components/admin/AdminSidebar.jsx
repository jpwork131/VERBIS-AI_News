  ...
  return (
    <aside className="w-72 flex flex-col shrink-0 border-r border-border bg-paper transition-colors duration-300">
      ...
      <div className="p-6 border-t border-border">
        ...
        <button className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-2xl text-muted hover:text-red-500 hover:bg-red-500/5 transition-all font-bold text-xs uppercase tracking-widest">
          <LogOut size={16} />
          <span>Sign Out</span>
        </button>
      </div>
